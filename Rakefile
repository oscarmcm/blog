...
# rake setup
desc "Setup the project requeriments"
task :setup do
  execute("sudo gem install jekyll")
...
# rake deploy
desc "Deploy the site based in the last commit"
task :deploy do
  puts "Deploying your awesome site \m/"
  execute("jgd")
end
